...
driver.get(
    'https://docs.google.com/forms/d/e/1FAIpQLScBejWF809oacjZlvkciXREi50fyHcq75l988KDJo3ycG7xkg/viewform'  #just a test . can be reformed according to form details:}
)
name = []
email = []
phone = []
